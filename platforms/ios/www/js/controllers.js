...
.controller('trackingCtrl', function ($scope, $state, $ionicSideMenuDelegate, $ionicScrollDelegate, $location, initMap, geolocation) {
    ...
    trackCtrl = this
    initMap.initIn(document.getElementById("map"))
...
.controller('journeyPlannerCtrl', function ($scope , initMap, geolocation ) {
        initMap.initIn(document.getElementById("map2"))
       geolocation.setMapCenter()
})
...
.controller('timetablesCtrl', function ($scope, initMap, geolocation) {
    initMap.initIn(document.getElementById("map3"))
    geolocation.setMapCenter()
})
